...
// Update buttons and status indicator text based on STATUS_MAP
...
checkin1.disabled = !STATUS_MAP.shelf.canCheckIn;
...
reserve3.disabled = !STATUS_MAP.overdue.canReserve;
checkout3.disabled = !STATUS_MAP.overdue.canCheckout;
checkin3.disabled = !STATUS_MAP.overdue.canCheckIn;
